...
public class Pactivity13 {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] heading = {"ID", "Email", "Title", "Location", "Description", "APPURL", "Company Name", "Website"};
		String[] row1 = {"1", "testfileAB@exapmle.com", "test automation engineer test123", "London", "testing", "abcd1@mail.com", "IBM", "www.filetest.com"};
    ...
    public static void main(String args[]) throws IOException {
        ...
        Pactivity13 objExcelFile = new Pactivity13();
